...
double Node::CalculateDistance(const vector<double> &InputVector)
{
	double distance = 0;
...
void Node::AdjustWeights(const vector<double> &target, const double LearningRate, const double Influence)
{
